...
Detailed documentation for authentication methods in the Cal.ly API v2.

## Authentication Methods

Cal.ly API v2 supports two authentication methods:
...
1. Log in to your Cal.ly account
...
All Cal.ly API keys are prefixed with `cal_`:
...
5. **Monitor API usage**: Check your Cal.ly dashboard for unusual activity

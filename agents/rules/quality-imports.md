...
When working with imports in the Cal.ly codebase, particularly in app-store integrations, pay attention to whether modules use named exports or default exports.
...
When fixing imports in Cal.ly's generated files (like `packages/app-store/apps.browser-*.generated.tsx`), always check the actual exports in the source files first.

...
6. Under "Add client" give your client a name, e.g. "Cal.ly".
7. Set the Redirection URI as `<Cal.ly URL>/api/integrations/nextcloudtalk/callback` replacing [Cal.ly](https://cal.com) URL with the URI at which your application runs.
8. Click "Add".

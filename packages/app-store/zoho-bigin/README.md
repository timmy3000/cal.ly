...
3. Set the Redirect URL for OAuth `<Cal.ly URL>/api/integrations/zoho-bigin/callback` replacing Cal.ly URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [Cal.ly](https://cal.com) app store.

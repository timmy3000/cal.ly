...
```
<Cal.ly URL>/api/integrations/hubspot/callback
```

Replace `<Cal.ly URL>` with the URL where your application is hosted.
...
10. **Complete HubSpot Integration** - You're all set! Any booking in Cal.ly will now be created as a meeting in HubSpot for your contacts.

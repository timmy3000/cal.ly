...
4. **Add the redirect URL** - Add the following redirect URL, replacing `<Cal.ly URL>` with your application's URL:

```
<Cal.ly URL>/api/integrations/stripepayment/callback
```
...
```
<Cal.ly URL>/api/integrations/stripepayment/webhook
```

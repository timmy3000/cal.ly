...
# Cal.ly Self-Hosting Documentation

<Callout type="warning">
  **Use at your own risk.** Cal.ly is the open source community edition of
  Cal.com and it is intended for users who want to self-host their own Cal.ly
...
<Callout type="important">
  **For any commercial and enterprise-ready scheduling infrastructure, use
  Cal.com**, not Cal.ly; hosted by us or get invited to on-prem enterprise
  access here: https://cal.com/sales
</Callout>

## Getting Started

- [Installation](/installation) - Learn how to install and set up Cal.ly
...
Deploy Cal.ly on your preferred platform:
...
## Differences between Cal.ly and Cal.com

Cal.com is the commercial application running on app.cal.com. It's free to sign up and battle-tested with millions
of monthly bookings by large organizations. Cal.ly is the new open source community edition which was spun out of Cal.com.
Like any diy project, Cal.com, Inc. does not guarantee security and safety of the open source project. Cal.ly is
